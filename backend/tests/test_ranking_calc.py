"""
Desktop-to-web parity coverage for ranking and star-cohort calculations.
"""
...
def test_count_10_star_companies_counts_only_exact_10s():
    companies = [
        _company(1, 100, rating=10.0),
        _company(2, 90, rating=9.9),
        _company(3, 80, rating=10.0),
        _company(4, 70, rating=10.0),
    ]
...
def test_star_band_metrics_use_ranked_slots_not_current_company_labels():
    ...
    result = compute_star_band_metrics(ranked, "own", own_weekly_income=850, own_rating=9)
