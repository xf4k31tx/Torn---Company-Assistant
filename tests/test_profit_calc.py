"""
Phase 4 coverage: compute_rolling_30day_sum() and its monthly_income/
monthly_profit wrappers.
"""
...
def test_rolling_30day_sum_includes_current_value_with_no_prior_rows():
    total = compute_rolling_30day_sum([], current_timestamp=1_700_000_000, current_value=1000.0,
                                       field_name="daily_income")
    assert total == 1000.0
...
def test_rolling_30day_sum_adds_rows_within_the_trailing_window():
    ...
    total = compute_rolling_30day_sum(prior_rows, now, current_value=1000.0, field_name="daily_income")
...
def test_rolling_30day_sum_is_a_total_not_an_average():
    ...
    total = compute_rolling_30day_sum(prior_rows, now, current_value=100.0, field_name="daily_income")
